...
- Add reviewed pregnancy/lactation safety content only from approved official, guideline, curated, or licensed sources.
- Add browser QA for the Care Assist panel and medication profile views.
- Expand structured history-field mapping as the history sheet model matures.
- Add a governed admin rule editor after review workflow is defined.
