...
1. Verify Emergency OB red flags protocol pack.
2. Verify AUB protocol pack.
3. Verify early pregnancy bleeding and ectopic protocol pack.
4. Verify preeclampsia and hypertension protocol pack.
5. Verify contraception protocol pack.
6. Verify antenatal routine protocol pack.
7. Verify postpartum protocol pack.
8. Verify pelvic floor physiotherapy protocol pack.
