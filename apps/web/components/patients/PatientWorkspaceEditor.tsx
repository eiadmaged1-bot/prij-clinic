...
export function PatientWorkspaceEditor({ patientId, patientType, permissions, roles, onApply }: { patientId: string; patientType: string; permissions: string[]; roles: string[]; onApply: (panels: WorkspacePanelPlacement[]) => void }) {
