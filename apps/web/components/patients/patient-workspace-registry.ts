...
export const patientWorkspaceRegistry: PatientWorkspaceItem[] = [
  ...
  item("billing", "Finance", "المالية", 70, "billing", [], ["billing.read", "billing.manage", "billing.report"], true, false, loadHeavy, ["Owner", "Admin", "Accountant"], "/billing/invoices?patientId=:patientId", "invoices"),
  item("more", "More", "المزيد", 80, "settings", [], ["patient.read"], true, true, loadLight),
  item("timeline", "Timeline", "الخط الزمني", 90, "timeline", [], ["patient.read"], false, false, loadHeavy, undefined, "/patients/:patientId/timeline", "items", true),
  ...
  item("history", "Audit / admin tools", "التدقيق / الإدارة", 160, "admin", [], ["audit.read"], false, false, loadHeavy, ["Owner", "Admin"], undefined, undefined, true)
];
