...
export const patientWorkspaceRegistry: PatientWorkspaceItem[] = [
  ...
  item("medications", "Active medications", "الأدوية الحالية", 26, "prescription", [], ["patient_medications.read"], true, true, loadLight, ["Owner", "Admin", "Doctor"], "/patients/:patientId/medications", "medications", true),
  item("prescriptions", "Recent prescriptions", "الوصفات الحديثة", 30, "prescription", ["create-prescription"], ["prescription.read"], true, true, loadLight, ["Owner", "Admin", "Doctor"], "/prescriptions?patientId=:patientId", "prescriptions", true),
  item("investigations", "Investigations and results", "الفحوصات والنتائج", 40, "investigations", ["create-request", "review-result"], ["clinical_requests.read", "investigation.read"], true, true, loadLight, ["Owner", "Admin", "Doctor"], "/clinical-requests?patientId=:patientId", "clinicalRequests", true),
