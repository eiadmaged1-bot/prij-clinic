...
export default function ExternalIntakePage() {
  ...
  return (
    <AppShell>
      ...
      <nav className="patient-tabs simple" aria-label="Patient Data Intake Center"><button className={tab === "google-forms" ? "active" : ""} type="button" onClick={() => setTab("google-forms")}>{t("googleForms")}</button><button className={tab === "google-sheets" ? "active" : ""} type="button" onClick={() => setTab("google-sheets")}>{t("googleSheets")}</button><button className={tab === "excel-csv" ? "active" : ""} type="button" onClick={() => setTab("excel-csv")}>{t("excelCsv")}</button><button className={tab === "manual" ? "active" : ""} type="button" onClick={() => setTab("manual")}>{t("manual")}</button><button className={tab === "import-history" ? "active" : ""} type="button" onClick={() => setTab("import-history")}>Import history</button><button className={tab === "history" ? "active" : ""} type="button" onClick={() => setTab("history")}>Submission history</button><button className={tab === "corrections" ? "active" : ""} type="button" onClick={() => setTab("corrections")}>{t("corrections")}</button><button className={tab === "data-hygiene" ? "active" : ""} type="button" onClick={() => setTab("data-hygiene")}>Data Hygiene</button><button className={tab === "quarantined" ? "active" : ""} type="button" onClick={() => setTab("quarantined")}>{t("testQuarantinedOwner")}</button></nav>
