...
export default function MedicationCenterPage() {
  ...
  return (
    <AppShell>
      ...
      <p className="notice medication-center-notice">No auto-prescribing. Market product data and clinical safety guidance are separate; doctor approval remains required.</p>
