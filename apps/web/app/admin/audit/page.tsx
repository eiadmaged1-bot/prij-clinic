...
export default function AdminAuditPage() {
  ...
  return <AppShell><section className="page-header"><div className="header-row"><div><p className="eyebrow">{t("ownerAdmin")}</p><h1>{t("auditLog")}</h1><p className="muted">{t("securityMatrix")}</p></div><span className="badge accent">{start}-{end} {t("of")} {data.total}</span></div></section><SafetyAlert />
