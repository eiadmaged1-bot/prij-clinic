  ...
  return (
    <AppShell>
      <section className="page-header">
        ...
        <p className="muted">Create staff accounts, set role presets, and review Permission toggles. System Owner access is reserved for Eyad.</p>
      </section>
        ...
        <div className="panel">
          <div className="section-heading">
            <div>
              ...
              <p className="muted">Passwords are hashed. Demo passwords are rejected in production.</p>
            </div>
          </div>
