...
function DailyList({ title, rows, actionLabel = "Open patient", doctorSelect = false, currentPatientCompact = false }: { title: string; actionLabel?: string; doctorSelect?: boolean; currentPatientCompact?: boolean; rows: Array<{ id: string; patientId: string; title: string; status: string; detail: string; invoice?: Invoice }> }) {
