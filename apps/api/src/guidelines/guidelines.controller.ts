...
export class GuidelinesController {
  ...
  async viewDocument(@Param("id") id: string, @CurrentUser() user: AuthUser, @Res() response: StreamResponse) {
  ...
  async downloadDocument(@Param("id") id: string, @CurrentUser() user: AuthUser, @Res() response: StreamResponse) {
