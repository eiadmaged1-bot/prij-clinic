...
function row(sourceKey, title, specialty, topic, versionLabel, originalUrl, guidelineStatus = "NEEDS_REVIEW", publicationDate = null) { const safeStatus = guidelineStatus === "ACTIVE" ? "NEEDS_REVIEW" : guidelineStatus; return { sourceKey, title, specialty, topic, versionLabel, originalUrl, guidelineStatus: safeStatus, publicationDate: publicationDate ? new Date(`${publicationDate}T00:00:00.000Z`) : null, reviewStatus: safeStatus === "ARCHIVED" ? "SOURCE_VERIFIED_ARCHIVED_METADATA" : "SOURCE_METADATA_NEEDS_DOCUMENT_LINK_REVIEW" }; }
