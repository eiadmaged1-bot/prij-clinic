...
const [shell, registry, layoutService, classicWorkspace, cockpitWorkspace] = await Promise.all([
...
console.log("Workspace discoverability regression PASS (12 assertions)");
