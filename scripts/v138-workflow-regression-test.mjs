...
const patientFile = read("apps/web/app/patients/[id]/page.tsx") + read("apps/web/components/patients/patient-workspace-registry.ts") + read("apps/web/app/patients/[id]/workspace-module-renderer.tsx") + read("apps/web/app/patients/[id]/panel-components.tsx");
...
assert(patientFile.includes("InfertilityWorkspacePanel") && patientFile.includes('item("infertility"'), "infertility tab renders through the patient workspace registry");
...
assert(shell.includes("<LanguageSwitcher />") && shell.includes("account-menu-panel"), "global language switcher remains visible in the production account shell");
...
assert(shell.includes("account-logout-button"), "logout remains visible in the production account menu");
