...
const routeDefinitions = [
  ...
  { method: "PATCH", path: "/queue/:queueTicketId/cancel", category: "queue", requiredPermission: "queue.status_update", allowedAs: "owner", denyAs: "doctor", fixtureBody: "queueCancel", notes: "Queue cancellation requires an auditable reason." },
