...
const routeDefinitions = [
  ...
  { method: "POST", path: "/appointments", category: "appointments", requiredPermission: "appointment.manage", allowedAs: "owner", denyAs: "nurse", fixtureBody: "appointment", notes: "Referenced patient and optional doctor branch scope are validated." },
  ...
  { method: "POST", path: "/queue/check-in", category: "queue", requiredPermission: "queue.manage", allowedAs: "owner", denyAs: "doctor", fixtureBody: "queue", notes: "Referenced patient and optional appointment scope are validated." },
  ...
  { method: "POST", path: "/encounters", category: "encounters", requiredPermission: "encounter.create", allowedAs: "owner", denyAs: "reception", fixtureBody: "encounter", notes: "Referenced patient and optional appointment scope are validated." },
