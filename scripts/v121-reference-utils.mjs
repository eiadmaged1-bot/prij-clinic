...
export const operationalModels = [
  ...
  ["patientHistorySheets", "patientHistorySheet"],
  ["patientOperationHistoryItems", "patientOperationHistoryItem"],
  ["patientMedicationHistoryItems", "patientMedicationHistoryItem"],
  ["patientInvestigationHistoryItems", "patientInvestigationHistoryItem"],
...
export const referenceModels = [
  ...
  ["medicationSearchTags", "medicationSearchTag"],
  ["medicationGenericTags", "medicationGenericTag"],
...
export async function buildOperationalDeletePlan(prisma, patientIds) {
  ...
  const plan = [
    ...
    item("patient operation history items", "patientOperationHistoryItem", { patientId: { in: patientIds } }),
    item("patient medication history items", "patientMedicationHistoryItem", { patientId: { in: patientIds } }),
    item("patient investigation history items", "patientInvestigationHistoryItem", { patientId: { in: patientIds } }),
    item("patient history sheets", "patientHistorySheet", { patientId: { in: patientIds } }),
