...
assert(service.includes("automaticMerge: false") && service.includes("Only READY rows"), "automatic merge/overwrite must be blocked");
...
assert(page.includes("Column mapping") && page.includes("Run dry-run preview") && page.includes("Import selected READY rows"), "guided import flow missing");
